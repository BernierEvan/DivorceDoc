        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-[var(--border-color)]">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="text-[var(--text-muted)] hover:text-[var(--text-primary)] transition p-2 rounded-full hover:bg-[var(--bg-tertiary)]"
                aria-label="Fermer"
              >
                <X className="w-5 h-5" />
              </button>
            ...
            <div className="p-6 overflow-y-auto flex-1 min-h-0">
              <p className="text-base text-[var(--text-secondary)] leading-relaxed whitespace-pre-wrap break-words">
                {content}
              </p>
            </div>
          </div>
